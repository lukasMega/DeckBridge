  ...
  /* prettier-ignore */
  {
    ...
    settings: {
      ...
      'boundaries/elements': [
        ...
        { type: 'dev-entry', mode: 'full', pattern: ['src/mirabox-smoke.ts', 'src/k1pro-probe.ts', 'src/d6-capture.ts', 'src/akp05-capture.ts', 'src/akp05-image-probe.ts', 'src/probe-utils.ts'] },
