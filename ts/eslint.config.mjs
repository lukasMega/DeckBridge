  ...
  /* prettier-ignore */
  {
    ...
    settings: {
      ...
      'boundaries/elements': [
        ...
        { type: 'app', mode: 'full', pattern: ['src/app.ts', 'src/driver-manager*.ts', 'src/cora-startup.ts', 'src/device-session.ts', 'src/extra-keys.ts', 'src/encoders.ts'] },
        { type: 'dev-entry', mode: 'full', pattern: ['src/mirabox-smoke.ts', 'src/k1pro-probe.ts', 'src/d6-capture.ts', 'src/akp05-capture.ts', 'src/probe-utils.ts'] },
